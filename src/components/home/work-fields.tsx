...
export function WorkFields() {
  return (
    <div className="py-7 max-sm:scroll-mt-10 flex flex-col gap-10 border border-[#F3F3F3] bg-[#FBFBFB] rounded-[2.5rem] max-w-[calc(100vw-450px)] max-sm:max-w-[calc(100vw-32px)] max-sm:rounded-[2rem] max-sm:py-4">
